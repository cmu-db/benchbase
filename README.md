...
| `chbenchmark` | :heavy_check_mark: | :heavy_check_mark: | :wavy_dash: | fails in CRDB 2.1.x, [issue #5](https://github.com/timveil-cockroach/oltpbench/issues/5), [~~issue #6~~](https://github.com/timveil-cockroach/oltpbench/issues/6); works well in CRDB 2.2 |
...
| `tpch` | :heavy_check_mark: | :heavy_check_mark: | :wavy_dash: | fails on Q9 in CRDB 2.1.x, [issue #12](https://github.com/timveil-cockroach/oltpbench/issues/12); works well in CRDB 2.2 |
