...
| `chbenchmark` | :heavy_check_mark: | :heavy_check_mark: | :x: | contains OLAP queries, not fit for CRDB, [issue #5](https://github.com/timveil-cockroach/oltpbench/issues/5), [~~issue #6~~](https://github.com/timveil-cockroach/oltpbench/issues/6)|
...
| `tpch` | :heavy_check_mark: | :heavy_check_mark: | :x: | contains OLAP queries, not fit for CRDB, `Q9` does not complete [issue #12](https://github.com/timveil-cockroach/oltpbench/issues/12) |
