...
public class BatchInsertYB extends YBMicroBenchmark {
    private static final Logger LOG = LoggerFactory.getLogger(BatchInsertYB.class);

    public BatchInsertYB(HierarchicalConfiguration<ImmutableNode> config) {
        super(config);
