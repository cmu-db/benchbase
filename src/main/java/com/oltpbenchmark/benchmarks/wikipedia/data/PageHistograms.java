...
public abstract class PageHistograms {
  ...
  public static final Histogram<Integer> TITLE_LENGTH =
  ...
  /** Revisions per page This seems way off because I think our sample data set is incomplete */
  public static final Histogram<Integer> REVISIONS_PER_PAGE =
      new Histogram<Integer>() {
        {
  ...
  public static final Histogram<Integer> NAMESPACE =
      new Histogram<Integer>() {
        {
          this.put(0, 40847);
          this.put(1, 15304);
  ...
  public static final Histogram<String> RESTRICTIONS =
