...
public abstract class AuctionMarkConstants {
  ...
  /**
   * This defines the maximum size of a small cache of ItemIds that we maintain in the benchmark
   * profile. For some procedures, the client will ItemIds out of this cache and use them as txn
   * parameters
   */
  ...
  /**
   * The default list of columns that we will return whenever we query the item table. This must
   * match the ordering expected in AuctionMarkWorker.processItemRecord()
   */
