...
DROP TABLE IF EXISTS pitchDetails CASCADE;
DROP TABLE IF EXISTS gameDetails CASCADE;  
DROP TABLE IF EXISTS playerDetails CASCADE;
DROP TABLE IF EXISTS teamDetails CASCADE;
