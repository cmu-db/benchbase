...
(
    ipb_id               int GENERATED BY DEFAULT AS IDENTITY NOT NULL,
...
CREATE TABLE page
(
    page_id           int GENERATED BY DEFAULT AS IDENTITY NOT NULL,
...
(
  rc_id             int GENERATED BY DEFAULT AS IDENTITY NOT NULL,
...
(
    rev_id         int GENERATED BY DEFAULT AS IDENTITY NOT NULL,
...
CREATE TABLE text
(
    old_id    int GENERATED BY DEFAULT AS IDENTITY NOT NULL,
