...
CREATE TABLE "followers" (
  f1 number(19,0) NOT NULL REFERENCES "user_profiles" (uid),
  f2 number(19,0) NOT NULL REFERENCES "user_profiles" (uid),
...
CREATE TABLE "tweets" (
  ...
  uuid number(19,0) NOT NULL REFERENCES "user_profiles" (uuid),
