...
public class ThreadBench implements Thread.UncaughtExceptionHandler {
    ...
    public static final class Results {
        ...
        private final Histogram<TransactionType> txnSuccess = new Histogram<TransactionType>(true);
        private final Histogram<TransactionType> txnAbort = new Histogram<TransactionType>(true);
        private final Histogram<TransactionType> txnRetry = new Histogram<TransactionType>(true);
