...
CREATE TABLE review (
  ...
  u_id int(11) NOT NULL REFERENCES user (u_id),
...
CREATE TABLE trust (
  source_u_id int(11) NOT NULL REFERENCES user (u_id),
  target_u_id int(11) NOT NULL REFERENCES user (u_id),
