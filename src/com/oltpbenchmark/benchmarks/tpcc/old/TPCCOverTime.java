...
public class TPCCOverTime {
	...
	public static void main(String[] args) throws QueueLimitException,
		...
		com.oltpbenchmark.benchmarks.tpcc.jTPCCConfig.defaultPaymentWeight = Integer
				.toString(payment);
		com.oltpbenchmark.benchmarks.tpcc.jTPCCConfig.defaultOrderStatusWeight = Integer
				.toString(order_status);
		com.oltpbenchmark.benchmarks.tpcc.jTPCCConfig.defaultDeliveryWeight = Integer
				.toString(delivery);
		com.oltpbenchmark.benchmarks.tpcc.jTPCCConfig.defaultStockLevelWeight = Integer
