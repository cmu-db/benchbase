...
public class ScanRecord extends Procedure{
    public final SQLStmt scanStmt = new SQLStmt(
            "SELECT * FROM usertable WHERE YCSB_KEY>? AND YCSB<?"
        );
        
    	//FIXME: The value in ysqb is a byteiterator
        public void run(Connection conn, int start, int count, Vector<HashMap<Integer,String>> results) throws SQLException {
